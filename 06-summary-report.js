...
`);
    ...
    console.log('Usage: node 06-summary-report.js [options]\n');
    console.log('Options:');
    ...
    console.log('  node 06-summary-report.js');
    console.log('  node 06-summary-report.js --source-dir ./src/i18n/locales');
    console.log('  node 06-summary-report.js --output summary.txt --verbose');
    console.log('  node 06-summary-report.js --output summary.txt --delete-reports');
    console.log('  node 06-summary-report.js --keep-reports\n');
  }
